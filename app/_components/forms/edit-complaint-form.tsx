...
// Hooks
import { useEditComplaint } from '@/app/_hooks/actions/use-edit-complaint';
...
export const EditComplaintForm = () => {
  const { openUpdate, setOpenUpdate, form, onUpdate, isLoadingUpdate, isLoadingFile } =
    useEditComplaint();
