...
import { electionResultsData } from "@/app/utils/faker";
...
const electionResultsColumns: ColumnDef<ElectionResultsHeader>[] = [
	...
	{
		accessorKey: "name",
		header: t("electionResults:table.header.name"),
	},
	{
		accessorKey: "number",
		header: t("electionResults:table.header.candidateNumber"),
	},
	{
		accessorKey: "state",
		header: t("electionResults:table.header.governorate"),
	},
	{
		accessorKey: "listNumber",
		header: t("electionResults:table.header.listNumber"),
	},
	{
		accessorKey: "votes",
		header: () => {
			return (
				<div className="flex justify-center items-center gap-4">
					<TrendingUp />
					<div>{t("electionResults:table.header.numberOfVotes")}</div>
				</div>
			);
		},
		cell: ({ row }) => {
	...
	},
	{
		...
		header: () => {
			return (
				<div className="flex justify-center items-center gap-4">
					<Hash />
					<div>{t("electionResults:table.header.listIndex")}</div>
				</div>
			);
		},
		cell: ({ row }) => {
